...
The native `fabricate` call plans and exports the fixed `kichad-production-10.0.4-v5` release
...
bounded structural validator. IPC-2581 is fixed to millimetres and precision 6, then parsed and
