...
The native `fabricate` call plans and exports the fixed `kichad-production-10.0.4-v10` release
...
board layer. Each page set is identity-checked and structurally validated. IPC-2581 is fixed to
