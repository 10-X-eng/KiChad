...
The native `fabricate` call plans and exports the fixed `kichad-production-10.0.4-v9` release
...
PostScript outputs; each page set is identity-checked and structurally validated. IPC-2581 is fixed
to millimetres and precision 6, then parsed and
