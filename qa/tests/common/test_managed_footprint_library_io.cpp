...
BOOST_AUTO_TEST_CASE( AtomicallyInstallsAndNativeLoadsGeneratedCurrentFormat )
{
  ...
  (footprint Product:SENSOR_2P
    ...
    (rectangle courtyard (start -1.5mm -1mm) (end 1.5mm 1mm)
      (radius 0.1mm) (stroke 0.05mm solid) (layers F.CrtYd) (fill none))
    (arc silk_arc (start -1.2mm 0mm) (mid -1mm -0.2mm) (end -0.8mm 0mm)
    ...
    (polygon fab_triangle (point -1mm -0.5mm) (point -0.5mm -0.5mm)
      (point -1mm 0mm) (stroke 0.05mm solid) (layers F.Fab) (fill solid))
    (bezier silk_curve (start -0.5mm 0.6mm) (control1 -0.2mm 0.3mm)
      (control2 0.2mm 0.9mm) (end 0.5mm 0.6mm)
      (stroke 0.08mm dash_dot) (layers F.SilkS))
    (text body_reference "${REFERENCE}" (at 0mm 0mm) (rotation 12.5deg)
      (layer F.Fab)
      (font (face default) (size 0.5mm 0.5mm) (line_spacing 1.2)
        (thickness 0.08mm) (bold true) (italic true))
      (justify left top true) (locked true) (keep_upright false) (knockout false))
    (text_box pin_note "PIN 1" (box -1.9mm -1.4mm -0.6mm -0.8mm)
      (rotation 12.5deg) (layer F.Fab) (margins 0.05mm 0.05mm 0.05mm 0.05mm)
      (font (face default) (size 0.3mm 0.3mm) (thickness 0.05mm))
      (justify center center false) (stroke 0.05mm dash)
      (border true) (knockout false) (locked true))
    (text_box polygon_note "P1"
      (polygon (point 0.6mm -1.4mm) (point 1.9mm -1.4mm)
        (point 1.9mm -0.8mm) (point 0.6mm -0.8mm))
      (rotation 0deg) (layer F.Fab) (margins 0mm 0mm 0mm 0mm)
      (font (size 0.3mm 0.3mm) (thickness auto))
      (justify right bottom false) (stroke 0mm solid)
      (border false) (knockout true) (locked false))
    ...
    (pad p4 (number 4) (type smd) (shape chamfered_rect) (at -1.5mm 1.5mm)
      (size 1mm 0.8mm) (layers F.Cu F.Mask F.Paste)
      (roundrect_radius 0.1mm) (chamfer_ratio 0.25)
      (chamfer top_left bottom_right))
    (pad p5 (number 5) (type smd) (shape custom) (at 1.5mm 1.5mm)
      (size 0.4mm 0.4mm) (layers F.Cu F.Mask F.Paste)
      (custom (anchor rect) (clearance convex_hull)
        (line stem (start -0.5mm 0mm) (end 0.5mm 0mm) (width 0.2mm))
        (circle lobe (center 0mm 0mm) (radius 0.35mm) (fill true))
