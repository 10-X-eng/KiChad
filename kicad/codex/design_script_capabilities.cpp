    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "pcb.placement", "pcb", "partial", { "board place", "board layout" },
                                "Schematic-linked footprint position, rotation, side, lock, deterministic create/delete, exact identity preservation, complete reference/value presentation, and qualified proximity/alignment/edge/group relationships.",
                                { "Constraint-driven placement synthesis and courtyard-aware automatic placement are absent." } ),
                    ...
                    capability( "pcb.routing", "pcb", "partial", { "board route", "board via", "board layout" },
                                "Explicit deterministic authored tracks, arcs, and vias with qualified geometry, via-count, length, and bundle-skew acceptance policy.",
                                { "Constraint-driven route synthesis, push-and-shove, walkaround, diff-pair routing, dragging, fanout, and autorouting are absent." } ),
