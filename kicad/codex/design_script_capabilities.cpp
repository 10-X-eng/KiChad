    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "schematic.text_graphics", "schematic", "partial", { "text" },
                                "Stable free text with simulation inclusion, rotation, complete typography, color, mirroring, and hyperlinks.",
                                { "Text boxes, shapes, curves, images, tables, and table cells are not represented yet." } ),
