    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "pcb.vias", "pcb", "partial", { "board via" },
                                "Stable net-connected through/blind/buried/micro vias with either one circular diameter or a complete front/inner/back or arbitrary per-layer copper padstack; circle/rect/oval/trapezoid/roundrect/chamfer and semantic custom-primitive geometry; offsets; top/bottom backdrilling; tenting; covering; plugging; filling; capping; post-machining; and lock state through the official KiCad 10 padstack IPC message.",
                                { "Unconnected-layer removal and forced-flash policy, and teardrops remain absent." } ),
