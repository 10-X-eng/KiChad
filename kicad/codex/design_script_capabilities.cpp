    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "symbols.authoring", "symbols", "partial", { "symbol" },
                                "AI-native project symbol creation with metadata, custom fields, inclusion flags, numbered/common units, De Morgan body styles, rectangles, and fully typed pins lowered to current KiCad 10 native libraries.",
                                { "Remaining symbol graphics, field layout, power/derived semantics, pin alternates, and publish workflows are not represented yet." } ),
