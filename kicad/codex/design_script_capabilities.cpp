    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "schematic.directive_labels", "schematic", "unrepresented", {},
                                "Directive labels and rule-area-like electrical directives.",
                                { "No directive-label form or backend exists." } ),
