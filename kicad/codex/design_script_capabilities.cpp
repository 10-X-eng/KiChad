    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "symbols.authoring", "symbols", "partial", { "symbol" },
                                "AI-native project symbol creation with metadata, completely laid-out mandatory/custom fields, inclusion flags, numbered/common units, De Morgan body styles, global/local power semantics, checked same-library derived aliases, all native vector/text graphics, and fully typed pins with alternate and jumper functions lowered to current KiCad 10 native libraries.",
                                { "Named body-style/unit display metadata, footprint filters, unit locking, embedded-font ownership, and publish workflows are not represented yet." } ),
