    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "schematic.text_graphics", "schematic", "partial",
                                { "text", "text_box", "polyline", "rectangle", "circle",
                                  "arc", "bezier", "image" },
                                "Stable free text, text boxes, all native drawing geometries, and digest-verified self-contained images with AI-readable descriptions.",
                                { "Tables and table cells are not represented yet." } ),
