    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "schematic.text_graphics", "schematic", "partial",
                                { "text", "text_box", "polyline", "rectangle", "circle",
                                  "arc", "bezier" },
                                "Stable free text, text boxes, and all five native schematic drawing geometries with complete geometry, stroke/fill, typography, simulation inclusion, color, mirroring, and hyperlinks.",
                                { "Images, tables, and table cells are not represented yet." } ),
