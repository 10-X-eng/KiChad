    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "footprints.authoring", "footprints", "partial", { "footprint", "pad", "model" },
                                "KDS-owned current-format footprint definitions with mandatory fields, metadata, attributes, jumper/net-tie groups, standard pads, all six native graphic primitives, rich text, rectangular/polygon text boxes, and project-local 3D assignments.",
                    ...
                    capability( "footprints.padstacks", "footprints", "partial", { "footprint pad" },
                                "SMD, connect, plated and non-plated through-hole pads with standard shapes, drills, offsets, mask/paste/clearance/thermal overrides, layer-removal policy, properties, and pin metadata.",
                                { "Custom primitives, chamfers, per-layer padstacks, tenting, plugging, filling, capping, and post-machining remain absent." } ),
