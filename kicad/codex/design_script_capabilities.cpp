    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "footprints.authoring", "footprints", "partial", { "footprint", "pad", "model" },
                                "KDS-owned current-format footprint definitions with mandatory fields, metadata, attributes, jumper/net-tie groups, standard pads, and project-local 3D assignments.",
                                { "Footprint graphics/text, local properties and rules, zones, groups, variants, component classes, embedded assets, and KLC geometry synthesis remain absent." } ),
