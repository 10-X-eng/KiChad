    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "symbols.authoring", "symbols", "partial", { "symbol" },
                                "AI-native project symbol creation with metadata, custom fields, inclusion flags, numbered/common units, De Morgan body styles, all native vector/text graphics with complete geometry, typography, stroke/fill, color, alignment, margins, privacy and hyperlinks, and fully typed pins lowered to current KiCad 10 native libraries.",
                                { "Field layout, power/derived semantics, pin alternates, and publish workflows are not represented yet." } ),
