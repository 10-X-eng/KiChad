    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "pcb.text_boxes_tables", "pcb", "partial",
                                { "board text_box" },
                                "Stable rectangular and polygonal board text boxes with complete margins, border stroke, typography, justification, hyperlink, knockout, layer, and lock state through the typed BoardTextBox API.",
                                { "Board tables and table cells are not represented yet." } ),
