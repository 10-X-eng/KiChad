    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "pcb.vias", "pcb", "partial", { "board via" },
                                "Stable net-connected through/blind/buried/micro vias with either one circular diameter or a complete front/inner/back or arbitrary per-layer copper padstack; circle/rect/oval/trapezoid/roundrect/chamfer and semantic custom-primitive geometry; offsets; complete unconnected-layer ring and per-layer forced-flash policy; top/bottom backdrilling; tenting; covering; plugging; filling; capping; post-machining; and lock state through the KiChad 10 typed padstack IPC message.",
                                { "Teardrops remain absent." } ),
