    ...
    JSON facets = JSON::array(
            {
                    ...
                    capability( "schematic.text_graphics", "schematic", "partial",
                                { "text", "text_box" },
                                "Stable free text and text boxes with complete geometry, margins, stroke/fill, typography, simulation inclusion, color, mirroring, and hyperlinks.",
                                { "Shapes, curves, images, tables, and table cells are not represented yet." } ),
