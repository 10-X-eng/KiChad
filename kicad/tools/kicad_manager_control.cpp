...
int KICAD_MANAGER_CONTROL::ToggleCodex( const TOOL_EVENT& aEvent )
{
    m_frame->ToggleCodexPanel();
    return 0;
}
...
void KICAD_MANAGER_CONTROL::setTransitions()
{
    ...
    Go( &KICAD_MANAGER_CONTROL::ToggleCodex,        KICAD_MANAGER_ACTIONS::showCodex.MakeEvent() );
